// src/components/MentorSidebar.jsx – responsive (auto‑collapses on mobile, hamburger menu)
...
function MentorSidebar() {
  ...
  // On small screens (<768px), auto‑collapse and use mobile overlay
  useEffect(() => {
    const handleResize = () => {
  ...
  const shouldShow = window.innerWidth >= 768 ? true : mobileOpen;
  ...
  return (
    <>
      ...
      >
        {/* Header same as before, but toggle button also works on mobile */}
