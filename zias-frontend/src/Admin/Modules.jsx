        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 sm:mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            ...
            <button
              ...
              className="shine flex items-center justify-center gap-2 bg-[#238636] hover:bg-[#2ea043] border border-[#2ea043]/40 text-white px-4 py-2 rounded-lg text-sm font-medium shadow-lg shadow-[#238636]/20"
            >
          ...
          <table className="min-w-full">
            ...
            <tbody className="bg-[#0d1117] divide-y divide-[#21262d]">
                                ...
                                <div key={day.id} className="border border-[#21262d] rounded-lg overflow-hidden">
                                  <div className="bg-[#0d1117] p-3 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 cursor-pointer hover:bg-[#161b22]" onClick={() => setExpandedDayId(expandedDayId === day.id ? null : day.id)}>
                                    <div className="flex items-center gap-3">
                                      ...
                                      <p className={`text-sm font-medium break-all ${day.is_completed ? "line-through text-[#7d8590]" : "text-[#c9d1d9]"}`}>
                                        {day.title}
                                      </p>
                                    </div>
              ...
              {paginatedModules.length === 0 && (
                <tr>
                  <td colSpan="5" className="text-center py-16 sm:py-20 text-[#7d8590]">No modules found</td>
                </tr>
              )}
            </tbody>
          </table>
