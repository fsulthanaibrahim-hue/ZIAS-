          ...
          <table className="min-w-full">
            ...
            <tbody className="bg-[#0d1117] divide-y divide-[#21262d]">
              {filteredStudents.length > 0 ? (
                  ...
                  <tr key={s.id} className="table-row-hover transition-colors duration-150 group">
                    <td className="px-3 sm:px-4 py-2.5 sm:py-3.5">
                      <div className="flex items-center gap-2 sm:gap-3">
                        <div className={`w-6 h-6 sm:w-8 sm:h-8 rounded-full bg-gradient-to-br ${getColor(s.username)} flex items-center justify-center text-white text-[10px] sm:text-xs font-bold shrink-0`}>
                    ...
                    <td className="px-3 sm:px-4 py-2.5 sm:py-3.5">
                      <span className="inline-flex items-center gap-1.5 bg-blue-500/10 text-blue-400 border border-blue-500/20 text-[10px] sm:text-xs font-medium px-2 py-0.5 sm:py-1 rounded-full whitespace-nowrap">
                        {s.course}
                      </span>
                    </td>
                    <td className="px-3 sm:px-4 py-2.5 sm:py-3.5">
                      <span className="inline-flex items-center bg-[#21262d] text-[#7d8590] border border-[#30363d] text-[10px] sm:text-xs font-mono px-2 py-0.5 sm:py-1 rounded-full whitespace-nowrap">
                        {s.batch}
                      </span>
                    </td>
                ...
                <tr>
                  <td colSpan="7" className="text-center py-16 sm:py-20">
