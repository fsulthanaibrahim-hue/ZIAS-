          ...
          <div>
            ...
            {student?.course && (
              <p className="text-sm text-[#7d8590] mt-1">
                Course: <span className="text-[#e6edf3]">{student.course}</span>
              </p>
            )}
          </div>
          <div className="flex gap-3">
            <Link
              to="/student/detailed-review"
              ...
              {modules.map((mod) => {
                ...
                return (
                  <div
                    key={mod.id}
                    className={`
                      relative bg-[#161b22] rounded-xl border border-[#21262d] 
                  ...
                  >
                    {isLocked ? (
                      <div className="p-5">
                        <div className="flex justify-between items-start">
                          <div className="flex-1">
                            ...
                            <span className="inline-block mt-3 text-xs bg-yellow-500/20 text-yellow-400 px-2 py-1 rounded-full">
                              🔒 Locked
                            </span>
                          </div>
                        </div>
                      ...
                      <Link to={`/student/module/${mod.id}`} className="block p-5">
                        <div className="flex justify-between items-start">
                          <div className="flex-1">
                            <h3 className="text-lg font-semibold text-[#e6edf3] group-hover:text-[#2ea043] transition">
                              {mod.title}
                            </h3>
                            <p className="text-[#7d8590] text-sm mt-1">
                              {mod.content || "No description"}
                          ...
                          <svg
                            className="w-5 h-5 text-[#7d8590] group-hover:text-[#2ea043] transition"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
