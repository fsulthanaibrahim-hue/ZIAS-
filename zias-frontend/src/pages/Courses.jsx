      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          ...
          {[
            ...
            >
              <course.Icon className="text-green-600 text-4xl mb-4 mx-auto" />
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-6">
          {[
            ...
            <div
              key={i}
              className="bg-white p-5 rounded-2xl shadow-md hover:shadow-xl transition transform hover:-translate-y-1 text-center"
            >
              <highlight.Icon className="text-green-600 text-3xl mb-3 mx-auto" />
              <h3 className="text-lg font-semibold text-gray-900 mb-1">{highlight.title}</h3>
              <p className="text-gray-600 text-xs leading-relaxed">{highlight.desc}</p>
            </div>
          ))}
        </div>
